...
void Graph::addVertex(int id){
	try{
		...
		if(vertices.insert(std::make_pair(id,Vertex(id))).second){		
			//create new edge list for new vertex	
			adjacencyList.insert(std::make_pair(id, std::list<std::pair<int, int>>()));			
		}
		else{
...
void Graph::addEdge(int firstVertex, int secondVertex, int dist){
	try{
		...
		edges.push_back(Edge(this->getVertexById(firstVertex),this->getVertexById(secondVertex),dist));
